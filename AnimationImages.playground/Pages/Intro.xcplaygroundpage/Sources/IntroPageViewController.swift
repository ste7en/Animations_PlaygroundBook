...
////        self.view.backgroundColor = (self.pages[initialPage] as! ViewController).backgroundColor
//        self.setPageControl()
//        
//        let scrollView = view.subviews.filter { $0 is UIScrollView }.first as! UIScrollView
//        scrollView.delegate = self
//        debugPrint("Background colors init")
//        debugPrint(self.pages.count)
//        self.pages.forEach {
//            page in
//            guard let page = page as? ViewController else { return }
//            backgroundColors.append(page.backgroundColor)
//        }
//        debugPrint("Background colors ended: \(self.backgroundColors.count)")
//
//    }
//    
...
//        {
//            debugPrint("percentageHorizontalOffset < 0.5")
//
...
//            debugPrint(percentageHorizontalOffset)
//            debugPrint(self.backgroundColors.count)
//            debugPrint(percentageHorizontalOffset)
//
...
//        
//        debugPrint(fromColor)
//        debugPrint(toColor)
//        debugPrint(withPercentage)
//        
